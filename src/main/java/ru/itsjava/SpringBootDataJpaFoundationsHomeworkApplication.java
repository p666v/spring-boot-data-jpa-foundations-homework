...
public class SpringBootDataJpaFoundationsHomeworkApplication {
    ...
    public static void main(String[] args) {
        var context = SpringApplication.run(SpringBootDataJpaFoundationsHomeworkApplication.class, args);
        UserService userService = context.getBean(UserService.class);
        PetService petService = context.getBean(PetService.class);

        userService.create(new User(5L, "Sergey", 35, petService.findById(1L)));
